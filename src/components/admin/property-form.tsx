...
import { Building2, MapPin, Image as ImageIcon, Sparkles, Save, ArrowLeft } from "lucide-react";
        ...
        <div className="mt-6">
          ...
          <TabsContent value="foto" className="m-0 border-0 p-0 focus-visible:outline-none">
            <Card className="shadow-sm border-border/50">
              ...
              <CardContent className="space-y-6 pt-6 flex flex-col items-center justify-center p-12 text-center text-muted-foreground border-2 border-dashed m-6 rounded-xl">
                 <ImageIcon className="w-12 h-12 mb-4 opacity-20" />
                 <p className="max-w-md">Modul sinkronisasi penyimpanan gambar (Cloudinary / S3) sedang diintegrasikan untuk fasa ini. Gunakan direktori media lokal untuk sementara.</p>
                 <Input type="url" name="heroImage" placeholder="Atau Tempel Tautan Gambar Hero (URL)" defaultValue={initialData?.heroImage} className="mt-4 max-w-md" />
              </CardContent>
            </Card>
          </TabsContent>
