...
export default function ContactPage() {
    ...
    const locations = {
        ...
        batu: {
            ...
            landmark: "10 menit dari Jatim Park dan Museum Angkut.",
        ...
        <div className="min-h-screen bg-background pb-20">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden bg-primary text-primary-foreground">
                ...
                <div className="container relative z-20 mx-auto px-4 text-center">
                    ...
                    >
                        Jam Operasional <span className="text-white/80 italic font-medium">05.00 Pagi - 22.00 Malam</span>
                    </motion.h1>
                    <motion.p
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        ...
                        <motion.div variants={fadeIn} initial="hidden" animate="visible" transition={{ delay: 0.2 }} className="bg-card border rounded-2xl p-8 shadow-xl shadow-black/5 text-center flex flex-col items-center hover:-translate-y-1 transition-transform">
                            ...
                            <a href="mailto:alvirahomestay@gmail.com" className="mt-auto w-full py-2.5 rounded-lg border border-border text-foreground font-semibold hover:bg-muted transition-colors">
                                Send Email
                            </a>
                        </motion.div>
                    </div>
            ...
            <section className="py-20 bg-muted/30">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        {/* TikTok */}
                        <motion.a
                            href="https://tiktok.com/@alvirahomestay" target="_blank" rel="noopener noreferrer"
                        ...
                        >
                            ...
                            <p className="text-gray-400 mb-8 relative z-10">@alvirahomestay</p>
                        ...
                        {/* Instagram */}
                        <motion.a
                            href="https://instagram.com/alvirahomestay" target="_blank" rel="noopener noreferrer"
                        ...
                        >
                            ...
                            <p className="text-white/80 mb-8 relative z-10">@alvirahomestay</p>
